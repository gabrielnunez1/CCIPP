        ...
        <div class="android-content mdl-layout__content">
         ...
         while ($muestra = mysqli_fetch_array($resultado)) {
          ...
          if (isset($_GET['operacion']) and $_GET['operacion']=="listar") {
            ...
            if (isset($evento_en_estemomento)) 
	{
...
?>
                            ...
                            <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-tablet mdl-cell--4-col-phone mdl-card mdl-shadow--3dp">
                              ...
                              ?>
                                            ...
                                            <?php echo $muestraEmpresa['nombre'];?>
                                    </a>
                                </div>
                            </div>
...
<?php
            ...
            //no existe evento por lo que no se imprime y se redirecciona
            ?>


    <center>
    <h2 class="">Lo sentimos... no hay nada aquí aun</h2>
  <div class="mdl-card__supporting-text">
  En este momento no hay eventos disponibles, te invitamos a ver la lista de comercios adheridos al club de descuentos.
  </div>
  <a href="club.php">
