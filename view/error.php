...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header">
        <div class="mdl-layout__header-row">
            ...
            <!-- Title -->
            <span class="mdl-layout-title">Inicia sesión</span>
...
<!-- Wide card with share menu button -->
                        ...
                        color: #fff;
                        height: 380px;
                        background: url('images/error.png') center / cover;
                        }
                        ...
                        <div class="mdl-card__title">
                            <h2 class="mdl-card__title-text">Error en inicio de sesión</h2>
                        </div>
                        <div class="mdl-card__supporting-text">
                            El usuario o la contraseña que has introducido es incorrecta. Vuelva a intentarlo.<br>
                        </div>
                        </div>
                    </div>
